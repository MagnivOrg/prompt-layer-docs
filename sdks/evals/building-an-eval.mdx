...
For Trajectory, tools must appear as `Tool: <name>` spans on the imported Trace; use a framework helper or `traceTool`. That contract lives on [Runner](/sdks/evals/agent-tracing).
