...
Every typed helper also accepts [weight, required, and thresholds](#weight-required-and-thresholds).

## Weight, Required, and Thresholds

Every typed helper accepts weight, required, and thresholds. Aggregation matches [Scorecards](/features/tables/scorecards) (weighted mean; default pass `0.8`, warn `0.6`).
