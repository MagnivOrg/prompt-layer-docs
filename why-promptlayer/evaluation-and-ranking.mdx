...
Ranking in PromptLayer revolves around this Score value. You can update it through the UI (see screenshot above) or programmatically ([More details here](/features/prompt-history/tracking-metadata-and-request-ids)).
