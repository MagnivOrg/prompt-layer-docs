---
title: "RBAC"
description: "Define reusable roles and assign fine-grained permissions to workspace members."
icon: "shield"
---
...
<Note>
[Enterprise Identity](/why-promptlayer/enterprise-identity/overview) automatically enables RBAC when turned on for an organization (and disables it when Enterprise Identity is turned off). IdP group mappings assign the default roles documented above—custom roles cannot be assigned through Directory Sync in the current release.
</Note>
