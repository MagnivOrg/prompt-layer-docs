...
The Shared Workspaces feature in PromptLayer is a collaborative tool designed to enhance teamwork and efficiency. It allows users to organize and share various data such as requests, prompt templates, and evaluations, in a central workspace.
...
This feature is available under the “Startup” or “Team” plan. Upgrade your plan by navigating to “Billing” in the settings cog at the top right corner of your PromptLayer account. Once upgraded, you can create a new workspace by clicking the 'Create Workspace' button from the workspace dropdown.
