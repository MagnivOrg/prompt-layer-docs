...
Enterprise customers can connect their identity provider for **SSO and Directory Sync (SCIM)** through [Enterprise Identity](/why-promptlayer/enterprise-identity/overview). Enterprise Identity automatically enables RBAC and lets Owners map IdP groups to workspace roles.
