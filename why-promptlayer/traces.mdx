...
In addition to automatic LLM request tracing, you can also use custom decorators (for Python) or `wrapWithSpan` (for JavaScript) to explicitly track span data for additional functions. This allows you to gather detailed information about function executions, including:
