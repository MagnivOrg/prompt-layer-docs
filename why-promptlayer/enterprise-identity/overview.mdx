...
<Steps>
  ...
  <Step title="Connect SSO">
    Open the WorkOS Admin Portal from **Organization Settings → Enterprise Identity**, configure your IdP, and run **Test SSO**. See [Setup](/why-promptlayer/enterprise-identity/setup).
  </Step>
...
<CardGroup cols={2}>
  <Card title="Setup" icon="plug" href="/why-promptlayer/enterprise-identity/setup">
    WorkOS Admin Portal, SAML/OIDC connection, Directory Sync, and Test SSO.
  </Card>
