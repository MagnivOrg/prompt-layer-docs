...
- **Startup**: The Startup plan is available at $59 per month. Logs will never expire, we will store up to 100,000 requests, you are able to create workspaces, and we will provide email support.

- **Team**: The Team plan is ideal for multi-player teams and is priced at $129 per month for 3 seats. Logs will never expire, we will store up to 1,000,000 requests, we will provide support through a shared Slack channel, you are able to create workspaces, run full evaluations, and you will receive early access to new features.
