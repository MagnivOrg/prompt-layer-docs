...
### **Pricing**
PromptLayer offers the following monthly pricing plans:

- **Free**: This plan is perfect for hackers and is completely free. We will store 7 days of logs and up to 1,000 requests.

- **Individual**: Designed for power users, the Individual plan is priced at $19 per month. We will store 7 days of logs, 10,000 requests, and provide email support.

- **Startup**: For startups and small teams, the Startup plan is available at $59 per month. Logs will never expire, we will store up to 100,000 requests, you are able to create workspaces, and we will provide email support.

- **Team**: The Team plan is ideal for multi-player teams and is priced at $129 per month. Logs will never expire, we will store up to 1,000,000 requests, we will provide support through a shared Slack channel, you are able to create workspaces with up to 3 members, and you will receive early access to new features.
