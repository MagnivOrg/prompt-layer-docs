...
<div className="promptlayer-landing">
  ...
  <section className="promptlayer-section" aria-labelledby="promptlayer-core-title">
    ...
    <div className="promptlayer-bento-grid">
      ...
      <a href="/why-promptlayer/workflows" className="promptlayer-bento-card promptlayer-card-interactive promptlayer-bento-card-wide">
        <span className="promptlayer-card-arrow" aria-hidden="true">→</span>
        <div className="promptlayer-card-icon promptlayer-card-icon-green">
          <img
        ...
        <div>
          <span className="promptlayer-card-pill">Workflows</span>
          <h3>Connect observability and evaluation loops.</h3>
          <p>
            Chain prompts and logic when your application needs more than a single request.
          </p>
        </div>
      </a>
