...
<div className="promptlayer-landing">
  <section className="promptlayer-hero">
    ...
    <div className="promptlayer-feature-grid">
      <a
        href="/features/prompt-registry/new-overview"
      ...
      >
        ...
        <p className="promptlayer-feature-description">
          Give teams a dedicated place to experiment with prompts and manage versions, separate from your application code.
        </p>
      </a>

      <a
        href="/features/tables/overview"
        className="promptlayer-feature-card promptlayer-card-interactive"
      >
        <div className="promptlayer-feature-badge">
          <img
        ...
        <h3 className="promptlayer-feature-title">Tables</h3>
        <p className="promptlayer-feature-description">
          Build datasets, run prompt experiments, evaluate outputs, score results, and preserve versions in one surface.
        </p>
      </a>

      <a
        href="/features/tables/best-practices"
        className="promptlayer-feature-card promptlayer-card-interactive"
      >
        <div className="promptlayer-feature-badge">
          <img
        ...
        <h3 className="promptlayer-feature-title">Table Best Practices</h3>
        <p className="promptlayer-feature-description">
          Structure rows, columns, scoring, versions, and request-history imports for reliable evaluation workflows.
        </p>
      </a>
      ...
      >
        ...
        <p className="promptlayer-feature-description">
          Review inference usage, cost, and latency. Inspect individual request/response pairs alongside full AI-application traces.
        </p>
      </a>
      ...
      >
        ...
        <p className="promptlayer-feature-description">
          Build complex, multi-step processes by chaining prompts and logical operations together.
        </p>
      </a>
  ...
  <section className="promptlayer-section">
    ...
    <div className="promptlayer-info-grid">
      ...
      <a href="/agents/overview" className="promptlayer-info-card promptlayer-card-interactive">
        <div className="promptlayer-info-icon">
          <svg
            viewBox="0 0 24 24"
            fill="none"
      ...
      <a href="/onboarding-guides/deployment-strategies" className="promptlayer-info-card promptlayer-card-interactive">
        <div className="promptlayer-info-icon">
          <svg
            viewBox="0 0 24 24"
            fill="none"
        ...
        <p className="promptlayer-info-description">
          Choose the right PromptLayer deployment pattern for your stack.
        </p>
      </a>

      <a
        href="/features/prompt-registry/webhook-events"
        className="promptlayer-info-card promptlayer-card-interactive"
      >
        <div className="promptlayer-info-icon">
          <svg
            ...
            aria-hidden="true"
          >
            <path d="M12 3.75v9m0 0 3.75-3.75M12 12.75 8.25 9" />
            <path d="M4.5 13.5 6.75 6h10.5l2.25 7.5" />
            <path d="M3.75 13.5h5.063a3.375 3.375 0 0 0 6.374 0h5.063v4.5a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18v-4.5Z" />
          </svg>
        </div>
        <h3 className="promptlayer-info-title">Webhooks</h3>
        <p className="promptlayer-info-description">
          Explore supported events and payload details.
        </p>
      </a>
