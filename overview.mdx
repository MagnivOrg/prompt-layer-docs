...
<div className="promptlayer-landing">
  <section className="promptlayer-hero">
    <div className="promptlayer-hero-copy">
      ...
      <a href="/quickstart-new" className="promptlayer-quickstart-button">
        Go to Quickstart
    ...
    <div className="promptlayer-feature-grid">
      ...
      >
        ...
        <h3 className="promptlayer-feature-title">Registry</h3>
        <p className="promptlayer-feature-description">
          Version prompts, tools, and skills outside your codebase with reusable templates and variables.
        </p>
      </a>
  ...
  <section className="promptlayer-section">
    ...
    <div className="promptlayer-info-grid">
      ...
      <a href="/agents/mcp" className="promptlayer-info-card promptlayer-card-interactive">
        <div className="promptlayer-info-icon">
          <svg
            viewBox="0 0 24 24"
            fill="none"
