...
| **PromptLayer MCP** | Lets MCP-compatible clients interact with PromptLayer workspace resources such as prompts, request logs, Smart Tables, workflows, tools, and skill collections. |
...
Use the PromptLayer MCP server when you want an MCP-compatible client to work with PromptLayer workspace resources such as prompts, request logs, Smart Tables, workflows, tools, and skill collections.
...
The PromptLayer MCP server exposes 79 tools covering all major PromptLayer features:
...
| **Smart Tables** | `list-smart-tables`, `create-smart-table`, `get-smart-table`, `update-smart-table`, `list-smart-table-sheets`, `create-smart-table-sheet`, `get-smart-table-sheet`, `update-smart-table-sheet`, `get-smart-table-sheet-import-operation`, `import-smart-table-sheet-file`, `import-smart-table-sheet-request-logs`, `list-smart-table-columns`, `create-smart-table-column`, `update-smart-table-column`, `list-smart-table-rows`, `add-smart-table-rows`, `get-smart-table-cell`, `update-smart-table-cell`, `recalculate-smart-table-cell`, `recalculate-smart-table-cells`, `list-smart-table-operations`, `create-smart-table-operation`, `get-smart-table-operation`, `cancel-smart-table-operation`, `get-smart-table-score`, `configure-smart-table-score`, `recalculate-smart-table-score`, `list-smart-table-versions`, `get-smart-table-version`, `create-smart-table-version`, `get-smart-table-score-history`, `list-legacy-smart-table-migrations`, `preview-legacy-smart-table-migration`, `migrate-legacy-to-smart-table`, `get-legacy-smart-table-migration-job` |
...
| **Tool Registry** | `list-tool-registries`, `get-tool-registry`, `create-tool-registry`, `create-tool-version`, `test-execute-tool-registry` |
| **Env Vars** | `list-workspace-env-vars`, `create-workspace-env-var`, `list-tool-env-vars`, `create-tool-env-var` |
