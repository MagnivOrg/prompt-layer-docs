...
The MCP server exposes 64 tools covering all major PromptLayer features:
...
| **Tracking** | `log-request`, `create-spans-bulk`, `track-prompt`, `track-score`, `track-metadata`, `track-group` |
