...
PromptLayer python library has support for OpenAI, Anthropic, and other LLM providers!
...
- Call `promptlayer_client.invalidate("prompt-name")` to clear one prompt from cache.
- Call `promptlayer_client.invalidate()` to clear the full SDK cache.
...
| `skills.pull()`    | Retrieves a skill collection or a specific version. | `promptlayer_client.skills.pull()`    | `async_promptlayer_client.skills.pull()`    |
| `skills.publish()` | Creates and publishes a new skill collection. | `promptlayer_client.skills.publish()` | `async_promptlayer_client.skills.publish()` |
| `skills.update()`  | Renames a skill collection and/or saves a new version. | `promptlayer_client.skills.update()`  | `async_promptlayer_client.skills.update()`  |
