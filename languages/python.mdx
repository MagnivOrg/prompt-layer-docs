...
## SDK Cache (Latency + Resilience)

You can enable SDK-level template caching to reduce latency and improve resilience during transient PromptLayer API issues:
...
See the full guide: [Python SDK Cache](/languages/python-cache).
