...
See [Integration Patterns](/onboarding-guides/deployment-strategies) for caching strategies.
...
For engineers: PromptLayer offers several [integration patterns](/onboarding-guides/deployment-strategies) including our Python or TypeScript SDKs, webhook-driven caching, fully managed agents, or [self-hosted](/self-hosted) deployments.
...
<Frame>
  <img
    src="/new-quickstart-images/release-labels-close.png"
    alt="Release labels"
  />
</Frame>
...
<Frame>
  <img
    src="/new-quickstart-images/prompt-ab-test-display.png"
...
<Frame>
  <img
    src="/new-quickstart-images/eval-example.png"
...
<Frame>
  <img
    src="/new-quickstart-images/analytics-display.png"
...
- [Prompt Management](/features/prompt-registry/new-overview) — Why prompt management matters
