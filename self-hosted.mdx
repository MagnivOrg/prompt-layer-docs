...
Self-hosted deployments can use [Enterprise Identity](/why-promptlayer/enterprise-identity/overview) (SSO and Directory Sync via WorkOS). Contact PromptLayer for WorkOS credential setup and webhook configuration in your environment.
