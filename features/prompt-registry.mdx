...
```js JavaScript
const template_dict = promptlayer.prompts.get({ prompt_name: "my_template" });
```
...
```js JavaScript
const template_dict = promptlayer.prompts.get({
...
```js JavaScript
const template = promptlayer.prompts.get({
  prompt_name: "my_template"
});
```
...
```js JavaScript
const pt = promptlayer.prompts.get({
...
const prompt = promptlayer.prompts.get({
  prompt_name: "my_prompt_with_functions",
});
