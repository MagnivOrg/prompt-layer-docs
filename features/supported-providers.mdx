...
- Function/Tool Calling (including built-in Responses API tools: Web Search, File Search, Image Generation) — see [Tool Calling](/features/prompt-registry/tool-calling#openai-and-azure-openai-responses-api).
