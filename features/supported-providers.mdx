...
- Function/Tool Calling (including built-in Responses API tools: Web Search, File Search, Code Interpreter, Image Generation, MCP, Shell, Apply Patch) — see [Tool Calling](/features/prompt-registry/tool-calling#openai-responses-api).
