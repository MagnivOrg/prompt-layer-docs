...
description: "Review the LLM providers and model capabilities PromptLayer supports."
icon: "list-check"
---
...
<img src="/images/playground/anthropic-caching-model-dropdown.png" alt="Advanced Model Controls with Prompt Caching enabled and 5 minutes selected" />
...
<img src="/images/playground/cache-icon-system-message.png" alt="System message block in the Playground with the Cache control visible" />
...
<img src="/images/playground/cache-icon-tools.png" alt="Tool & Output Editor with Cache control next to a tool definition" />
...
<img src="/images/anthropic-cache-request-log-detail.png" alt="Request log detail showing Cache Write token count and prompt/response" />
