...
- An object with the following properties:
  ...
  - `ascending`: (Optional) A boolean indicating whether an increase in this value is considered positive (`true`). If absent, we default to true.

**Examples**
- Simple value: `42`
- Object with metadata: `{"value": 42, "ascending": true}`

The optional `ascending` property can be used to indicate how changes in the value should be interpreted when comparing evaluations. This is particularly useful for automated reporting and analysis tools.
