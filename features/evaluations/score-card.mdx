...
- `score_matrix` (optional): A list of lists of lists, representing one or more matrices of drilled-down scores. These matrices can contain titles or numbers and will be displayed for comparison.
