...
These nodes enable iterating over collections or executing repeated operations within Agents. For comprehensive documentation including API examples, see the [Loop Nodes](/running-requests/workflow-loops) guide.

<AccordionGroup>
  <Accordion title="FOR_LOOP">
