...
When you update a template that's included as a snippet in another template, both webhook events will be triggered for both templates. 
This way you can still keep track of the changes on your templates while also leveraging the power of snippets.
