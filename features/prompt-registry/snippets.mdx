...
- [Snippet Dependency Ordering](/features/prompt-registry/snippet-dependency-ordering) — publish snippets in dependency-first order when using the API or MCP
- [Get Snippet Usage](/reference/get-snippet-usage) — find which prompts reference a snippet
- [Publish Prompt Template](/reference/templates-publish) — programmatically publish prompt templates
