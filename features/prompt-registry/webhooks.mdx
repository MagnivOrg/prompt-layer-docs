...
Webhooks can be set up to receive notifications about events on PromptLayer.

For event names and payload details, see [Supported Events](/features/prompt-registry/webhook-events).
