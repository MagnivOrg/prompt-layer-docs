...
```python Python SDK
from promptlayer import templates

all_prompts = templates.all()
```

```js JavaScript
const all_prompts = promptlayer.templates.all()
```
...
```js JavaScript
const all_prompts = promptlayer.templates.all({ per_page: 100 })
```
...
```js JavaScript
const all_prompts = promptlayer.templates.all({ page: 2 })
```
