...
Use a prompt template as a reference snippet in your template. The prompt template will be pulled in at runtime.
Only completion prompts can be used as snippets, and you can reference by template version, label, or just the template name and get the latest version each time.

<img src="/images/composables-30fps.gif" />
