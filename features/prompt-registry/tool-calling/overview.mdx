...
- Structured Outputs: Tool arguments are always in JSON format, enforced by JSONSchema at the API level. See our [Structured Outputs](/features/prompt-registry/tool-calling/structured-outputs) documentation for more details.
