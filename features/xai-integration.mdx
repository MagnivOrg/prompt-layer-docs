...
4. Configure each model:
   ...
   - **Model Name**: Enter the Grok model identifier (e.g., `grok-3`)
...
- **`grok-3`**: Latest Grok model with advanced reasoning capabilities
- **`grok-2-vision-1212`**: Grok 2 with vision capabilities
- **`grok-2-1212`**: Previous generation Grok 2 model
