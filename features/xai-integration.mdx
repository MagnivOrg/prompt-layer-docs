...
**TODO: ADD SCREENSHOT OF XAI CUSTOM PROVIDER MODAL**
...
4. Configure each model:
   ...
   - **Model Name**: Enter the Grok model identifier (e.g., `grok-2-1212`)
   - **Display Name**: A friendly name like "Grok 2" or "Grok Beta"
   - **Model Type**: Chat
5. Repeat for each model you want to use

**TODO: ADD SCREENSHOT OF CREATING XAI CUSTOM MODEL**
...
- **`grok-2-1212`**: Latest Grok 2 model with improved reasoning
- **`grok-2-vision-1212`**: Grok 2 with vision capabilities
- **`grok-beta`**: Beta access to experimental features
...
**TODO: ADD SCREENSHOT OF USING GROK IN PLAYGROUND**
...
You can also use Grok models programmatically with the PromptLayer SDK:
...
# Use Grok through custom provider
...
response = client.chat.completions.create(
    ...
    # Note: Avoid unsupported parameters like 'seed'
)
...
<Info>
Because xAI uses OpenAI-compatible endpoints, you can use Grok with most PromptLayer features that support OpenAI, including streaming and prompt templates. Just be mindful of parameter compatibility differences.
</Info>
