...
For resolver strings, dependency edges, cell read/write shapes, and score configuration objects, see [Tables Data Model](/features/tables/data-model).
...
<CardGroup cols={2}>
  ...
  <Card title="Tables Data Model" icon="diagram-project" href="/features/tables/data-model">
    Reference resolver strings, dependencies, cell shapes, and score configuration.
  </Card>
