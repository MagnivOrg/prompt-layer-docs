...
To define scorecard criteria in code and run a full experiment from a local agent or prompt function, use [SDK Evals](/sdks/evals/overview). Those APIs create an experiment sheet, configure scorers, and recalculate the scorecard for you. For the SDK helper reference, see [Scorers](/sdks/evals/scorers/overview).
