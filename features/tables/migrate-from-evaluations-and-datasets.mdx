...
| Add dataset row | [Add rows](/reference/table-sheet-rows-add) |
| Edit dataset cell | [Update cell](/reference/table-sheet-cells-update) |
| Read row or cell output | [List rows](/reference/table-sheet-rows-list), [Get cell](/reference/table-sheet-cells-get) |
