...
1. Open the test panel on the signal editor.
2. Add request logs from history or from your current scope.
3. Run **Try signal** on individual logs or **Test all** across the set.
4. Review the true/false result, reasoning, and citation for each log.
...
The **Signals** list also shows processed, true, and false counts for each signal so you can track volume and distribution over time.
