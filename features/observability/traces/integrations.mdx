...
<CardGroup cols={3}>
  <Card
    title="LiteLLM"
    icon="/images/provider-logos/litellm.svg"
    href="#litellm"
  >
    Model router
  </Card>
  <Card
    title="LlamaIndex"
    icon="/images/provider-logos/llamaindex.svg"
    href="#llamaindex"
  >
  ...
  <Card
    ...
    href="#openai-agents-sdk"
  >
    JavaScript and Python agents
  </Card>
  <Card
    title="OpenClaw"
    icon="/images/provider-logos/openclaw.svg"
    href="#openclaw"
  >
    Agent plugin
  </Card>
  <Card
    title="Vercel AI SDK"
    icon="/images/provider-logos/vercel.svg"
    href="#vercel-ai-sdk"
  >
  ...
  <Card
    title="Pydantic AI"
    icon="/images/provider-logos/pydantic.svg"
    href="#pydantic-ai"
  >
    Python agents
  </Card>
  <Card
    ...
    icon="/images/provider-logos/langchain.svg"
    href="#langchain--langsmith"
  >
    Framework and observability
  </Card>
  <Card
    title="OpenRouter"
    icon="/images/provider-logos/openrouter.svg"
    href="#openrouter"
  >
    Model router
  </Card>
