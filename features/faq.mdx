...
## How do I use web search and other pre-built tools from OpenAI Responses API?
...
### How to Add Pre-Built Tools in PromptLayer
...
4. **Add a pre-built tool**:
   ...
   - Browse available tools like **Web Search**, **Code Interpreter**, or **Image Generation**
...
### Example: Web Search in Action

When you add the **Web Search** tool and ask a question like "What is PromptLayer?", you'll see:

- A **Thinking** section showing the model's reasoning process
- **Web search status updates** like "Preparing search parameters..." and "Found web results for: PromptLayer what is PromptLayer"
- A **comprehensive answer with citations** pulled from current web sources
- A **sources indicator** (e.g., "1 source") showing where the information came from

The model will use web search automatically when it needs up-to-date information to answer your query accurately.
