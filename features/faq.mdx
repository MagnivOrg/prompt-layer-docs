...
2. Use the [`run()` method](/running-requests/promptlayer-run) to execute prompts, or use [`log_request`](/features/prompt-history/custom-logging) to log requests made with your own client.
...
See the [Async Support section](/languages/python#async-support) for more details.
...
Learn how to set up and use these tools in our [Tool Calling documentation](/features/prompt-registry/tool-calling#openai-and-azure-openai-responses-api).
