...
A well-prepared dataset serves as input variables for your prompt evaluation. For prompt that generate haikus, this could include various topics or human-written haiku samples.
