...
- **Content Generation Pipelines**: Automating creative writing, summarization, or structured text generation.
- **Data Processing**: Sequentially refining, filtering, or transforming data using multiple prompts.
- **Decision-Making AI**: Automating multi-step logical reasoning across different models or APIs.

By structuring workflows in a modular way, AI systems can adapt dynamically based on real-time outputs.

### Why Use Agentic Workflows?

Agentic workflows streamline complex tasks by reducing manual intervention and enabling scalable automation. They allow prompts to work together seamlessly, ensuring consistency and logical progression across multi-step AI interactions.
...
1. Navigate to the **Prompt Registry**. ([Read more](/features/prompt-registry/overview))
2. Click the **Create Prompt** button to start a new prompt.
3. Fill in the required details such as the **Prompt Title**, **Messages**, and **Input Variables**.  
...
4. Select the **Model** and configure its **Parameters**.
5. Save your prompt by clicking on **Create Prompt**.

For our example, we'll create the following prompts:

- **ai-poet**: Generates a haiku based on a user-provided topic.
- **ai-poetry-commentary**: Generates commentary from the haiku.
- **ai-poetry-final**: Compiles the haiku and commentary into a final creative message.

See the image below for the prompts we'll create:
...
- [Learn more about Agentic Workflows tracing](/why-promptlayer/agents).
