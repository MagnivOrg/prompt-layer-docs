...
PromptLayer also supports `jinja2` syntax. Learn more about [Template Variables](/features/prompt-registry/template-variables) and how to use them effectively.
</Info>
...
- Read the guide to [run a prompt in our SDK](/running-requests/promptlayer-run).
