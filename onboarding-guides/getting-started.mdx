...
- Use **input variables** to make responses predictable.
  - Input variables are placeholders for dynamic data that can be passed to the prompt.
...
The user message provides specific input, similar to selecting a recipe based on available ingredients.

**Example: A Prompt for Writing a Haiku**

| SYSTEM                                                                                                                                                                                                               | USER      |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| You are a skilled poet specializing in haiku.<br/><br/>Your task is to write a haiku based on a topic provided by the user.<br/><br/>The haiku must have 17 syllables,<br/>structured in three lines of 5, 7, and 5. | `{topic}` |
