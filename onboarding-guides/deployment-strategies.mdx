...
If your prompts use [snippets](/features/prompt-registry/snippets), publish snippet dependencies before parent templates. See [Snippet Dependency Ordering](/features/prompt-registry/snippet-dependency-ordering) for the required publish order and a multi-pass CI workflow.
