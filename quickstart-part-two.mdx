...
<Frame>
  <img src="https://placehold.co/1200x600/e8e8e8/999999?text=Screenshot+needed:+Log+from+SDK+run" alt="Log from SDK run" />
</Frame>
...
<Frame>
  <img src="https://placehold.co/1200x600/e8e8e8/999999?text=Screenshot+needed:+Log+with+metadata" alt="Log with metadata" />
</Frame>
