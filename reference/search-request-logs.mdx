...
openapi: "POST /api/public/v2/request-logs/search"
...
<Warning>
This endpoint is rate limited to **10 requests per minute**. Results are capped at **50 per page**.
</Warning>
...
```bash
curl -X POST https://api.promptlayer.com/api/public/v2/request-logs/search \
