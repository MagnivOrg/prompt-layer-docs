...
Use `"content": [{"type": "text", "text": "your message"}]` instead of `"content": "your message"`. Using a plain string will result in a "Malformed Request" error. See the [Prompt Blueprints](/running-requests/prompt-blueprints) docs for the full format.
</Warning>
