...
Generate API keys from the API keys page in your PromptLayer dashboard. Each workspace has its own API key, and requests use the workspace associated with the key by default.
