...
For resolver strings, dependency objects, cell shapes, and score configuration, see [Tables Data Model](/features/tables/data-model).
...
- [Delete Table](/reference/tables-delete)
...
- [Delete Sheet](/reference/table-sheets-delete)
...
- [Delete Column](/reference/table-sheet-columns-delete)
