...
The primary way to access PromptLayer is through our [Python](/sdks/python) or [JavaScript](/sdks/javascript) SDK libraries. The SDKs are built on top of our REST API.
