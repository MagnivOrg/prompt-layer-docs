...
The `image_variable` attribute allows you to dynamically insert a list of images into prompt template messages. This attribute is part of the `ImageContent` structure and can be used to include images based on a specified variable name.

### Structure

The `image_variable` is nested within the message content.
    ...
    “content”: [
        {
            “type”: “image_url”,
            “image_url”: {“url”: “”},
            “image_variable”: “image_variables”
        }
    ]
}
```
