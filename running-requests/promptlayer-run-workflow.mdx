...
The method returns a dictionary (Python) or object (JavaScript) containing information about the workflow execution, and the response structure depends on the `return_all_outputs` parameter.
