...
```js JavaScript
const city_choice_prompt = await promptlayer.prompts.get({
  prompt_name: "city_choice",
});
const city_choice_prompt_v1 = await promptlayer.prompts.get({
  prompt_name: "city_choice",
  version: 1,
});
const city_choice_prompt_prod = await promptlayer.prompts.get({
  prompt_name: "city_choice",
  label: "prod",
});
